...
skier_images = ["./img/skier_down.png", "./img/skier_right1.png", "./img/skier_right2.png",
                "./img/skier_left2.png", "./img/skier_left1.png"]
...
while running:
    ...
    if hit:
        if hit[0].type == "tree" and not hit[0].passed:  # crashed into tree
            points = points - 100
            skier.image = pygame.image.load("./img/skier_crash.png")  # crash image
            animate()
            pygame.time.delay(1000)
            skier.image = pygame.image.load("./img/skier_down.png")  # resume skiing
            skier.angle = 0
            speed = [0, 6]
            hit[0].passed = True
